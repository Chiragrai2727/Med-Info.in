                ...
                <footer className="py-12 border-t border-[var(--color-ink)]/10">
                  <div className="max-w-7xl mx-auto px-4 text-center">
                    ...
                    <div className="flex justify-center gap-6 mt-4">
                      <Link to="/privacy" className="text-xs text-[var(--color-ink)]/50 hover:text-[var(--color-ink)] transition-colors font-bold uppercase tracking-widest">{t('privacyPolicy')}</Link>
                      <a href="https://cdsco.gov.in/" target="_blank" rel="noopener noreferrer" className="text-xs text-[var(--color-ink)]/50 hover:text-[var(--color-ink)] transition-colors font-bold uppercase tracking-widest">{t('cdscoOfficial')}</a>
                    </div>
