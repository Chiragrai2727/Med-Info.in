...
export const MagicBentoCard = ({
  ...
  return (
    <div
      ref={cardRef}
      className={`magic-bento-card magic-bento-card--border-glow ${className} ${enableStars ? 'particle-container' : ''}`}
...
const BentoCardGrid = ({ children, gridRef, className = '' }: { children: ReactNode; gridRef: React.RefObject<HTMLDivElement>; className?: string; }) => (
