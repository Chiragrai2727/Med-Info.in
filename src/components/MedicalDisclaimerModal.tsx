        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="space-y-6 text-slate-600 dark:text-slate-300 font-medium leading-relaxed">
              <div className="bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/20 rounded-2xl p-5 text-amber-900 dark:text-amber-200">
              ...
              <div className="flex gap-4 items-start bg-blue-50 dark:bg-blue-500/10 border border-blue-100 dark:border-blue-500/20 rounded-2xl p-5 text-blue-900 dark:text-blue-100">
                <div className="mt-1 bg-blue-200 dark:bg-blue-500/20 rounded-full p-2 text-blue-700 dark:text-blue-300 shrink-0">
                  <FileText className="w-4 h-4" />
                </div>
                <div>
                  <h3 className="font-bold mb-1">AI & Data Limitations</h3>
                  <p className="text-sm opacity-90 leading-relaxed items-center">
                    While our AI-powered scanner utilizes advanced models and our data is cross-referenced with the <a href="https://cdsco.gov.in" target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-700 dark:hover:text-blue-300 transition-colors">Central Drugs Standard Control Organisation (CDSCO)</a> and other verified medical databases, AI can occasionally generate incorrect or misleading results. You must always manually verify the information extracted and consult with a healthcare professional regarding any medical concerns.
                  </p>
                </div>
              </div>
            ...
            <div className="mt-10">
              <button
                ...
                className="w-full py-4 bg-primary text-white font-black uppercase tracking-widest rounded-2xl hover:bg-primary-hover active:scale-[0.98] transition-all flex items-center justify-center gap-2 shadow-lg shadow-primary/25"
              >
