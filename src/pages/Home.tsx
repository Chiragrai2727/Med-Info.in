  ...
  return (
    <div className="min-h-screen pt-40 pb-20 bg-bg">
      <Helmet>
        ...
        <meta property="og:image" content="https://aethelcare.xyz/aethelcare-brand-logo.png?v=10" />
        ...
        <meta property="twitter:image" content="https://aethelcare.xyz/aethelcare-brand-logo.png?v=10" />
      </Helmet>
