      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-red-600 text-white p-10 md:p-16 rounded-[4rem] relative overflow-hidden mb-16 shadow-2xl">
          ...
          <div className="relative z-10">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/20 text-white text-xs font-black uppercase tracking-[0.2em] rounded-full mb-6 backdrop-blur-md">
              <ShieldAlert className="w-4 h-4" /> Official CDSCO Data
            </div>
            <h1 className="text-5xl md:text-7xl font-black tracking-tighter mb-6">Banned Drugs Registry</h1>
            <p className="text-xl md:text-2xl text-red-100 font-medium max-w-3xl leading-relaxed">
              A comprehensive list of medications prohibited for manufacture and sale in India under Section 26A of the Drugs & Cosmetics Act, 1940.
            </p>
          </div>
        </div>
        ...
        <div className="mb-12 relative">
          ...
          <input
            ...
            placeholder="Search banned drugs by name or side effect..."
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredDrugs.map((drug, index) => (
            ...
            >
              ...
              <div className="mb-6">
                <p className="text-xs font-black uppercase tracking-widest text-gray-400 mb-1">Primary Risk</p>
        ...
        {filteredDrugs.length === 0 && (
          <div className="text-center py-20">
            ...
            <h3 className="text-2xl font-black text-gray-900 mb-2">No banned drugs found</h3>
