            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-12 sm:gap-8">
              ...
              <div>
                <div className="w-full aspect-[4/5] bg-[var(--color-ink)]/5 rounded-2xl mb-6 border border-[var(--color-ink)]/10 overflow-hidden relative group">
                  <img src="/chirag.jpg" alt="Chirag Rai" className="w-full h-full object-cover filter grayscale group-hover:grayscale-0 transition-all duration-500" referrerPolicy="no-referrer" onError={(e) => { e.currentTarget.src = 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=800'; }} />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </div>
                <div className="flex items-center gap-3 mb-1">
                  <h4 className="font-black text-2xl text-[var(--color-ink)] tracking-tight">Chirag Rai</h4>
                  <a href="https://www.linkedin.com/in/chirag-rai-77ab23240/" target="_blank" rel="noopener noreferrer" className="text-[#0A66C2] hover:opacity-80 transition-opacity" title="LinkedIn Profile">
              ...
              <div>
                <div className="w-full aspect-[4/5] bg-[var(--color-ink)]/5 rounded-2xl mb-6 border border-[var(--color-ink)]/10 overflow-hidden relative group">
                  <img src="/sagar.jpg" alt="Dr. Sagar Rai" className="w-full h-full object-cover filter grayscale group-hover:grayscale-0 transition-all duration-500" referrerPolicy="no-referrer" onError={(e) => { e.currentTarget.src = 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?auto=format&fit=crop&q=80&w=800'; }} />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </div>
                <div className="flex items-center gap-3 mb-1">
