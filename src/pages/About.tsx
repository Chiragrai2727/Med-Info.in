              ...
              <div className="md:col-span-6 md:col-start-7 py-12">
                <div className="mb-8">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <a href="https://linkedin.com/in/chiragrai01" target="_blank" rel="noopener noreferrer" className="p-3 bg-surface border border-border rounded-full hover:bg-primary/5 hover:border-primary/20 transition-all group/link">
                      <Linkedin className="w-5 h-5 text-text-secondary group-hover/link:text-primary transition-colors" />
                    </a>
                  </div>
                </div>
              ...
              <div className="md:col-span-6 md:order-1 py-12">
                <div className="mb-8 text-right">
                  ...
                  <div className="flex items-center justify-end gap-6">
                    <a href="https://linkedin.com/in/dr-sagar-rai" target="_blank" rel="noopener noreferrer" className="p-3 bg-surface border border-border rounded-full hover:bg-success/5 hover:border-success/20 transition-all group/link">
                      <Linkedin className="w-5 h-5 text-text-secondary group-hover/link:text-success transition-colors" />
                    </a>
