          ...
          <div className="space-y-12">
            <section>
              ...
              <p className="text-gray-600 leading-relaxed font-medium">
                MedInfo India is designed with a "Privacy First" approach. We do not collect, store, or share any personally identifiable information (PII). Your search history is stored locally on your device for offline access and is never transmitted to our servers.
              </p>
            </section>
