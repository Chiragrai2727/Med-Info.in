  ...
  return (
    <div className="min-h-screen bg-transparent pt-32 sm:pt-48 pb-32">
      <div className="max-w-4xl mx-auto px-4">
        ...
        {/* Header & Counter */}
        {!isPremium && (
          <div className="mb-12 p-8 backdrop-blur-2xl bg-white/60 rounded-[3rem] border border-white shadow-[0_20px_50px_rgba(0,0,0,0.03)] group">
            ...
            <div className="h-5 bg-blue-600/5 rounded-full overflow-hidden p-1 shadow-inner">
              <motion.div 
                initial={{ width: 0 }}
        ...
        <div className="text-center mb-16 px-4">
          ...
          {/* Tabs */}
          <div className="flex p-2 backdrop-blur-3xl bg-white/60 rounded-[2.5rem] mb-12 border border-white shadow-xl overflow-hidden">
            ...
            >
              ...
              <div className="p-10 flex flex-col sm:flex-row gap-6">
                ...
                <button 
                  ...
                  className="flex-1 py-6 bg-blue-600 text-white rounded-[2rem] font-black text-xs uppercase tracking-widest flex items-center justify-center gap-4 shadow-2xl hover:bg-blue-700 active:scale-95 transition-all"
                >
          ...
          <div className="relative">
            {!scanResult && !loading && !showPreview && (
              ...
              className="backdrop-blur-3xl bg-white/30 border-[3px] border-dashed border-white rounded-[5rem] p-16 text-center hover:bg-white/60 transition-all duration-700 group shadow-[0_20px_50px_rgba(0,0,0,0.02)]"
            >
              <div className="flex flex-col items-center gap-10">
                <div 
                  onClick={() => cameraInputRef.current?.click()}
                  className="w-32 h-32 bg-white/80 rounded-[3rem] flex items-center justify-center text-blue-200 group-hover:bg-blue-600 group-hover:text-white transition-all duration-700 shadow-xl cursor-pointer active:scale-90 border border-white"
                >
                ...
                <div className="flex flex-col sm:flex-row gap-6 w-full max-w-lg">
                  <button 
                    ...
                    onClick={() => cameraInputRef.current?.click()}
                    className="flex-1 py-6 bg-blue-600 text-white rounded-[2rem] font-black text-xs uppercase tracking-[0.2em] flex items-center justify-center gap-4 disabled:opacity-40 active:scale-95 shadow-2xl hover:bg-blue-700 border border-blue-500/30"
                  >
                    Open Camera
                  </button>
                  <button 
                    ...
                    className="flex-1 py-6 backdrop-blur-md bg-white border-2 border-white text-slate-900 rounded-[2rem] font-black text-xs uppercase tracking-[0.2em] flex items-center justify-center gap-4 disabled:opacity-40 active:scale-95 shadow-sm hover:border-blue-600"
                  >
                    Upload File
                  </button>
                </div>
          ...
          {!isPremium && !nudgeDismissed && !scanResult && !loading && (
            <motion.div 
              ...
              animate={{ opacity: 1, y: 0 }}
              className="mt-12 backdrop-blur-3xl bg-white/60 p-10 rounded-[3.5rem] flex items-center justify-between shadow-2xl relative overflow-hidden group border border-white"
            >
               <div className="absolute top-0 right-0 w-64 h-64 bg-blue-600/5 rounded-full -mr-32 -mt-32 blur-[100px] group-hover:scale-150 transition-transform duration-1000" />
               <div className="flex items-center gap-6 relative z-10">
                 <div className="w-14 h-14 backdrop-blur-md bg-blue-600/10 rounded-2xl flex items-center justify-center border border-blue-200/20 shrink-0 shadow-lg">
                    <Zap className="w-7 h-7 text-blue-600 fill-blue-600" />
                 </div>
                 <div className="pr-12">
                   <p className="font-black text-slate-900 text-xl tracking-tight mb-2 uppercase leading-none">Handwriting Detected?</p>
               ...
               <div className="flex flex-col items-end gap-3 shrink-0 relative z-10">
                 <button onClick={() => navigate('/pricing')} className="p-3 bg-blue-600 text-white rounded-2xl hover:scale-110 active:scale-95 transition-all shadow-xl">
                    <ChevronRight className="w-6 h-6" />
                 </button>
                 <button onClick={() => setNudgeDismissed(true)} className="text-[9px] uppercase font-black tracking-[0.3em] text-slate-400 hover:text-slate-600 transition-opacity">Dismiss</button>
               </div>
            </motion.div>
          )}
            ...
            <div className="py-32 text-center flex flex-col items-center">
              <div className="relative w-48 h-48 mb-12">
                ...
                <motion.div 
                  ...
                  className="absolute inset-0 border-[8px] border-blue-600 rounded-[3.5rem] border-t-transparent shadow-2xl"
                />
                <div className="absolute inset-0 flex items-center justify-center">
                  <Zap className="w-14 h-14 text-blue-600 fill-blue-400 animate-pulse" />
                </div>
              </div>
      ...
      {/* Footer Disclaimer */}
      <div className="fixed bottom-0 left-0 right-0 p-5 backdrop-blur-3xl bg-white/70 text-slate-900 border-t border-white/40 text-center z-[100] shadow-[0_-10px_50px_rgba(0,0,0,0.05)]">
